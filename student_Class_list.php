...
<body>
    ...
    <div class="container" class="row g-3">
      ...
      <tr>
        ...
        <td> <a href=" https://localhost/REGISTRATION/student_project.php?pro=<?php $_SESSION["suS"] = $ro['semester'] ?>&amp;cor=<?php echo $ro['sub'] ?>"><button class="btn btn-outline-dark btn-lg px-5" type="submit">Go</button></a>
            <td>
                </tr>
            <?php
        }
